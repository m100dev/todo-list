...
function addBtn() {
    let todo = document.form1.userInput.value;
    // Checks that the user presses cancel or adds an actual value before pressing enter
    if (todo.length < 3 || todo === "   ") {
        alert("Please enter a valid item to the task list at least 3 characters long");
    } else {
        // Sets the value of todo to what user just typed
        todo = document.form1.userInput.value;
